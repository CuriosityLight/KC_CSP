...
def room4(player, enemy, enemy_killed, action4, current_room, coin_amount,):
    if enemy_killed == 0:
...
while True:
    if current_room == 1:
        ...
        player, enemy, enemy_killed, action4, current_room, coin_amount = room4(player, enemy, enemy_killed, action4, current_room, coin_amount)
    elif current_room == 5:
